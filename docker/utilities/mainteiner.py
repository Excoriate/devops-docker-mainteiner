...
remove_all_docker_images = "docker rmi $(docker images -a -q)"
...
docker_run = "docker run -p 127.0.0.1:3002:3002 api" #Specific port and specific tag. Change it if you want. 
